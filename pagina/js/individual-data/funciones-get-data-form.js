...
export function get_anio_carrera_for_select(id_carrera, id_select_anio_carrera) {
    $.ajax({
        url: '../../php/individual_data/get-anio-carrera.php',
        type: 'POST',
        data: { id_carrera: id_carrera },
        ...
        success: function (respuesta) {
            $("#" + id_select_anio_carrera).empty();
            crear_primer_opcion('Año de Carrera', id_select_anio_carrera);
            ...
            data_carreras.datos.forEach(function (valor) {
                ...
                objOpcion.setAttribute("value", valor.id_anio);
                objOpcion.innerHTML = valor.anio;
                document.getElementById(id_select_anio_carrera).appendChild(objOpcion);
            });
        },
        error: function (jqXHR, textStatus, errorThrown) {
            console.error('Error en la solicitud:', textStatus, errorThrown);
...
export function get_materias_for_select(id_carrera, id_anio_carrera, id_select_materia) {
    $.ajax({
        ...
        success: function (respuesta) {
            ...
            $("#" + id_select_materia).empty();
            crear_primer_opcion('Materia', id_select_materia);
            ...
            data_materias.datos.forEach(function (valor) {
                ...
                document.getElementById(id_select_materia).appendChild(objOpcion);
            });
        },
        error: function (jqXHR, textStatus, errorThrown) {
            console.error('Error en la solicitud:', textStatus, errorThrown);
...
export function get_semestre_for_select(id_carrera, id_anio_carrera, id_materia, id_select_semestre) {
    ...
    $.ajax({
        ...
        success: function (respuesta) {
            ...
            var data_semestre = JSON.parse(respuesta);
            data_semestre.datos.forEach(function (valor) {
                var objOpcion = document.createElement("option");
                objOpcion.setAttribute("value", valor.id_semestre);
                objOpcion.innerHTML = valor.semestre;

                document.getElementById(id_select_semestre).appendChild(objOpcion);
            });
        },
        error: function (jqXHR, textStatus, errorThrown) {
            console.error('Error en la solicitud:', textStatus, errorThrown);
    ...
    $.ajax({
        ...
        success: function (respuesta) {
            ...
            data_comisiones.comisiones.forEach(function (valor) {
                ...
                objOpcion.setAttribute("value", valor.id_comision);
                objOpcion.innerHTML = valor.comision;
                document.getElementById(id_select_comisiones).appendChild(objOpcion);
            });
        },
        error: function (jqXHR, textStatus, errorThrown) {
            console.error('Error en la solicitud:', textStatus, errorThrown);
